...
class Go2NodeFactory:
    ...
    def create_launch_arguments(self) -> List[DeclareLaunchArgument]:
        ...
        return [
            ...
            DeclareLaunchArgument('lidar', default_value='false', description='Launch LiDAR pipeline'),
            DeclareLaunchArgument('tts', default_value='false', description='Launch TTS node'),
        ]
    ...
    def _create_pointcloud_to_laserscan_node(self, namespace: str = None) -> Node:
        ...
        lidar_condition = IfCondition(LaunchConfiguration('lidar', default='false'))
        if namespace:
            # Multi-robot setup
            return Node(
    ...
    def create_core_nodes(self) -> List[Node]:
        with_lidar = LaunchConfiguration('lidar', default='false')
        with_tts   = LaunchConfiguration('tts', default='false')
